...
# https://github.com/zcaceres/spec_augment/blob/master/SparseImageWarp.ipynb
...
#     print('Squeezed query_points', unstacked_query_points[0].shape, unstacked_query_points[1].shape)
    ...
    for dim in index_order:
        ...
        alpha = queries - floor
        min_alpha = torch.tensor(0.0, dtype=grid_type).float()
        max_alpha = torch.tensor(1.0, dtype=grid_type).float()
